    ...
    <AppLayout>
      ...
      <div className="mb-8 animate-fade-in-up">
        ...
        <p className="mt-1 text-muted-foreground">
          Offline-first learning infrastructure — ultra-low storage footprint
        </p>
      </div>
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <MetricCard
          title="Domains"
          value={domainsAvailable}
          subtitle="Subject areas"
          icon={<Database className="h-5 w-5" />}
          delay={80}
        />
        <MetricCard
          title="Storage Used"
          value={`${storageUsedKB} KB`}
          subtitle={`of ${MAX_STORAGE_KB} KB budget`}
          icon={<HardDrive className="h-5 w-5" />}
          delay={160}
        />
        <MetricCard
          title="Difficulty Split"
          value={`${difficultyDistribution.beginner}/${difficultyDistribution.intermediate}/${difficultyDistribution.advanced}`}
          subtitle="B / I / A"
